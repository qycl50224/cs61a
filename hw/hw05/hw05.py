...
class VendingMachine:
    ...
    def deposit(self, amount):
        if self.current_stock == 0:
            ...
            return ('Current balance: ${}'.format(self.current_balance))
    ...
    def vend(self):
        if self.current_stock > 0:
            if self.current_balance >= self.price:
                ...
                delta = self.price - self.current_balance
                return ('You must deposit ${} more.'.format(delta))
        else:
            return ('Machine is out of stock.')

    def restock(self, amount):
        self.current_stock += amount
        return ('Current {} stock: {}'.format(self.product, self.current_stock))
...
def preorder(t):
    ...
    # return list(t.label) + [preorder(b) for b in t.branches]
...
def store_digits(n):
    ...
    def helper(l):
        ...
        if len(l) == 1:
            return Link(int(l[0]))
        return Link(first,helper(l[1:]))
    return helper(list(str(n)))
